...
export const cases = pgTable(
  ...
  (table) => [
    uniqueIndex("cases_org_case_number_idx").on(table.organizationId, table.caseNumber),
...
export const caseAssignments = pgTable(
  ...
  (table) => [
    ...
    index("case_assignments_organization_id_idx").on(table.organizationId),
  ]
);
...
export const caseNotes = pgTable(
  ...
  (table) => [
    index("case_notes_organization_id_idx").on(table.organizationId),
  ]
);
...
export const caseTimeline = pgTable(
  ...
  (table) => [
    index("case_timeline_organization_id_idx").on(table.organizationId),
  ]
);
...
export const caseParties = pgTable(
  ...
  (table) => [
    index("case_parties_organization_id_idx").on(table.organizationId),
  ]
);
...
export const pipelineStages = pgTable(
  ...
  (table) => [
    index("pipeline_stages_organization_id_idx").on(table.organizationId),
  ]
);
...
export const caseStageHistory = pgTable(
  ...
  (table) => [
    ...
    index("case_stage_history_organization_id_idx").on(table.organizationId),
  ]
);
...
export const stageAutomations = pgTable(
  ...
  (table) => [
    index("stage_automations_organization_id_idx").on(table.organizationId),
  ]
);
