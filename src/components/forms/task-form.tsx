...
import { createTaskSchema, type CreateTaskInput } from "@/lib/validators/calendar";
...
export function TaskForm({ cases, users }: TaskFormProps) {
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(val) => form.setValue("priority", val as CreateTaskInput["priority"])}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
